package com.enderzombi102.enderlib.quilt.compat;

import com.enderzombi102.enderlib.quilt.Const;
...
class EnderlibModuleMod implements Mod {
	...
	public @NotNull NativeImageBackedTexture getIcon( FabricIconHandler handler, int i ) {
		return handler.createIcon(
			FabricLoader.getInstance().getModContainer( "enderlib-quilt" ).orElseThrow(),
